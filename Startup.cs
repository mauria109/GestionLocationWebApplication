...
using GestionLocationWebApplication.Filtre;
...
using GestionLocationWebApplication.Validation;
...
namespace GestionLocationWebApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ArticleActionFilter>();
            services.AddTransient<IValidator<Article>, ProductValidation>();
