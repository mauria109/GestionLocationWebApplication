...
namespace GestionLocationWebApplication.Controllers
{
    public class CategorieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Label,Code")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Label,Code")] Categorie categorie)
        {
            if (id != categorie.Id)
            {
                return NotFound();
