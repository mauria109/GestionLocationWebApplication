...
/*namespace GestionLocationWebApplication.Models.Entities
{
    public class ArticleController : Controller
    {
        ...
        public ArticleController(IArticleService service, IWebHostEnvironment webHostEnvironment,DataContext context, IArticleMapper articleMapper, IArticleRepository articleRepository)
        {
            _service = service;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //ChargerData();
            //return View(_articleMapper.MapArticleEnArticle(ArticleRepository.Articles().ToList()));
        }
